...
"${FC}" ${FLAGS} src/color_class.f90 src/glyph_class.f90 src/charac_class.f90 src/gui.f90 app/saville_code.f90 $(pkg-config --cflags --libs gtk-4-fortran)
